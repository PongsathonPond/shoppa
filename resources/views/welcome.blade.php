            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link bg-light rounded-2" href="{{ route('login') }}">เข้าสู่ระบบ</a>
                        </li>
                        {{-- <li class="nav-item">
                            <a class="nav-link bg-light rounded-2" href="#" tabindex="-1"
                                aria-disabled="true">ออกจากระบบ</a>
                        </li> --}}
                    </ul>
                    {{-- <form class="d-flex">
                    ...
                    <div class="card shadow" style="width: 18rem">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-3">
                                <a href="{{ route('login') }}" class="btn btn-success">รายละเอียด</a>
